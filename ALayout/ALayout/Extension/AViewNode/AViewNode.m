...
{
    self.property[ValueKey(A_background)] = background;
}

- (NSString*)background
{
    return self.property[ValueKey(A_background)];
}

- (void)setTextColor:(NSString *)textColor
{
    self.property[ValueKey(A_textColor)] = textColor;
}

- (NSString*)textColor
{
    return self.property[ValueKey(A_textColor)];
}
