...
- (void)measure:(MeasureSpec)widthMeasureSpec heightSpec:(MeasureSpec)heightMeasureSpec
{
    ...
    if(minSize.width > 0 && widthMeasureSpec.size < minSize.width)
    {
        widthMeasureSpec.size = minSize.width;
    }
    
    if(minSize.height > 0 && heightMeasureSpec.size < minSize.height)
    {
        heightMeasureSpec.size = minSize.height;
    }
